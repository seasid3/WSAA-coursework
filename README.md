...
**`assignment04-github.py`** — Reads "bookapidao.py" from a public GitHub repository, replaces all instances of "Andrew" with "Orla", and pushes the updated file "getrepoinformation.py" to Orla's repository, using a personal access token.

**`getrepoinformation.py`** — is the output file which is the updated version of "bookapidao.py" with "Andrew" replaced by "Orla".

### How it works - assignment04-github.py
1. Reads `bookapidao.py` from [andrewbeattycourseware/wsaa-courseware](https://github.com/andrewbeattycourseware/wsaa-courseware) — no token needed as it is a public repo
...
4. Pushes the updated file to this repository as `getrepoinformation.py`
...
| `getrepoinformation.py` | Output file - updated version of `bookapidao.py` with "Andrew" replaced by "Orla" |
